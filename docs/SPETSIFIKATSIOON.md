...
## Sisukord
- [Ülevaade](SPETSIFIKATSIOON.md#Ülevaade)
- [Seotud dokumendid](#seotud-dokumendid)
- [Mõisted](SPETSIFIKATSIOON.md#mõisted)
...
- [Põhi-JSON-veebileht](#põhi-json-veebileht)
...
- [Infosüsteemi detailkirjeldus](#infosüsteemi-detailkirjeldus)
- [Andmekogu detailkirjeldus](#andmekogu-detailkirjeldus)
...
- [Andmebaasi kirjeldamine JSON-struktuurina](#andmebaasi-kirjeldamine-json-struktuurina)
- [Teenuste kirjeldamine JSON-struktuuriga](#teenuste-kirjeldamine-json-struktuuriga)
- [Valdkonnasõnastike kirjeldamine JSON-struktuuriga](#valdkonnasõnastike-kirjeldamine-json-struktuuriga)
- [Klassifikaatorite kirjeldamine JSON-struktuuriga](#klassifikaatorite-kirjeldamine-json-struktuuriga)
- [XML varade kirjeldamine JSON-struktuuriga](#xml-varade-kirjeldamine-json-struktuuriga)
